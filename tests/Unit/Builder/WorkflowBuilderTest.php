    ...
    public function testAllTransitionMethods(): void
    {
        ...
        $config = (new WorkflowBuilder())
            ->node(BuilderTestHandler::class)
                ...
                ->onEvent(BuilderTestFailHandler::class)
                ->onExit(BuilderTestSuccessHandler::class)
            ->build();
        ...
        $this->assertSame(BuilderTestFailHandler::class, $transitions[WorkflowResult::ON_EVENT]);
        $this->assertSame(BuilderTestSuccessHandler::class, $transitions[WorkflowResult::ON_EXIT]);
    }
    ...
    public function testComplexWorkflowChain(): void
    {
        ...
        $config = (new WorkflowBuilder())
            ->node(BuilderTestHandler::class)
                ->onSuccess(BuilderTestSuccessHandler::class)
                ->onFail(BuilderTestFailHandler::class)
                ->onSkip(BuilderTestHandler::class)
            ->node(BuilderTestSuccessHandler::class)
                ->onSuccess(BuilderTestFailHandler::class)
        ...
        $this->assertSame(BuilderTestHandler::class, $transitions1[WorkflowResult::ON_SKIP]);
